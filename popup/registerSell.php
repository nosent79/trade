...
<div>
    <div>
        ...
        <table class="g_blue_table" id="goods_info">
            ...
            <tr>
                <th>물품종류</th>
                <td>
                    <input type="radio" name="tr_kind" id="rd_money" class="g_radio" value="M">
    ...
    <div style="padding-top:20px; text-align:center;">
        <button id="btnRegisterSell" class="button g_green1">판매등록</button>
        <button id="btnCancel" class="button g_red1">등록취소</button>
    </div>
</div>
    <script>
        $("#btnRegisterSell").click(function(e) {
            e.preventDefault();

            var url = "<?=SITE_URL.SITE_PORT?>/ajax/registerSell.php";
