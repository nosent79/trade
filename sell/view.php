    ...
    <form id="frmPay" name="frmPay" method="post">
        ...
        <div id="charge_box">
            <ul id="price_info" class="g_sideway">
                <li><img src="http://img3.itemmania.com/images/sell/img_buy_price.gif" width="52" height="16" alt="판매금액" class="g_icon"></li>
        ...
        <div class="g_btn">
            <img src="http://img2.itemmania.com/images/btn/btn_sell.gif" width="128" height="37" alt="판매신청" class="g_button first" id="btnApplyTrade">
